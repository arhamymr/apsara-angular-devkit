      ...
      <div class="features-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        @for (feature of features(); track feature.title) {
          <div class="feature-card bg-white dark:bg-gray-800 rounded-2xl p-8 text-center border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg dark:hover:shadow-xl">
            <div class="feature-icon w-16 h-16 bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl flex items-center justify-center mx-auto mb-5">
...
export class FeaturesSectionComponent {
  features = signal<Feature[]>([
    { icon: '⚡', title: 'High Performance', description: 'Optimized Angular build with lazy loading and efficient change detection' },
    { icon: '🔒', title: 'Type Safe', description: 'Strict TypeScript configuration with full type inference' },
    { icon: '🎨', title: 'Custom Design', description: 'Beautiful Tailwind-based design system' },
    { icon: '📦', title: 'Standalone Components', description: 'Modern Angular architecture without NgModules' },
    { icon: '🏗️', title: 'Clean Architecture', description: 'Well-organized folder structure following best practices' },
    { icon: '🔄', title: 'Signals Ready', description: 'Reactive state management using Angular Signals' }
  ]);
}
