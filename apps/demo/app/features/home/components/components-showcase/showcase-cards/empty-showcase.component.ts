  ...
  template: `
    <app-card class="flex-1 flex flex-col h-full">
      <div class="mb-6">
        ...
        <p class="text-sm text-dimmed">Placeholder states for empty content</p>
      </div>
      <div class="flex-1 flex items-center justify-center min-h-[200px]">
        <div class="flex flex-col items-center text-center gap-3">
          ...
          <span class="text-sm text-dimmed max-w-[200px]">Start a conversation by sending a message</span>
