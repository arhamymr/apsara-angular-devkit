...
import { SortHeaderComponent, SortEvent, CardComponent, TabsComponent, TableComponent } from '@apsara/ui';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, SortHeaderComponent, CardComponent, TabsComponent, TableComponent, CodeSnippetComponent],
  template: `
