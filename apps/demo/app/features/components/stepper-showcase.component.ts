...
import { StepperComponent, CardComponent, TabsComponent, TableComponent } from '@apsara/ui';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, StepperComponent, CardComponent, TabsComponent, TableComponent, CodeSnippetComponent],
  template: `
