...
import { DividerComponent, CardComponent, TabsComponent, TableComponent } from '@apsara/ui';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, DividerComponent, CardComponent, TabsComponent, TableComponent, CodeSnippetComponent],
  template: `
