...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, SidenavComponent, AlertComponent, AlertTitleComponent, AlertDescriptionComponent, ButtonComponent, CardComponent, TabsComponent, TableComponent, LucideAngularModule, CodeSnippetComponent],
  template: `
    ...
    <section id="sidenav" class="mb-16 scroll-m-20">
      <div class="mb-6">
        ...
        <p class="text-muted-foreground">A side navigation component for app layouts</p>
      </div>
